      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p
              className="mt-4 text-background/70 max-w-md leading-relaxed"
              style={{ fontFamily: "var(--font-sans)" }}
            >
              Clínica de estética dedicada a realçar sua beleza natural com
        ...
        <div className="pt-8 border-t border-background/20 flex flex-col md:flex-row justify-between items-center gap-4">
          <p
            ...
            style={{ fontFamily: "var(--font-sans)" }}
          >
            &copy; {new Date().getFullYear()} Naiany Ferreira. Todos os direitos
            reservados.
          </p>
          <p
            className="text-sm text-background/50"
